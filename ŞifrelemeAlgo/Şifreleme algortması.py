harfKarsiliklari={"A":"023U0","B":"G63F7","C":"A978F","D":"CXO*8","E":"5CV<Y","F":"AKJS2","G":"BM896","H":"PA298","İ":".89G5","J":"IUG98","K":"AS892","L":"A9XCA","M":"ÇY902","N":"SD092","O":"76USX","P":"AS09X","Q":"52ASV","R":"AS65C","S":"LK2093","T":"LALEE","U":"ÇÖZ87","V":"SAXL2","W":"ASXVC","X":"86UHS","Y":"JV892","Z":"*863J",
                  "a":"SAL52","b":"098XS","c":"ŞAS31","d":"XZ509","e":"DŞİ98","f":"BJ547","g":"GLE75","h":"XBC79","i":"85HDÖ","j":"KAS92","k":"JF074","l":"KQ027","m":"GF732","n":"AK984","o":"KSA98","p":"XC983","q":"HHD92","r":"CAK78","s":"ALX42","t":"CXM64","u":"52GFS","v":"66787","w":"AÇX97","x":"GDB97","y":"2ÖSAF","z":"HF974"," ":"GDF1Ç"}
...
def desifreEt(sifresiCozulecekMetin):#desifreEt fonksıyonu ve dekripte edilecek olan metnn parametre olarak verilmesi
    sayac=0
    sayac2=5
    str=""
    ...
    for item in sifresiCozulecekMetin:#Sifreli metin uzerınde donmeye baslıyorum. Karakter karakter item uzerınde gezınıyorum.
        ...
        if(sayac==sayac2):#sayac 5in ve katlarının degerınde oldugu zaman birer birer harfleri almısız demektir.
            ...
            sifreParcalari.append(str)#elde edilen her harfi bir sifreParcalari listesi icerisine alıyorum.
...
desifreEdilmisMetin=desifreEt(sifresiCozulecekMetin)#desifreEt fonksıyonunu burada karsılıyorum ve aldıgım sıfrelenecek metni fonksıyona parametre olarak verıyourm.
